...
public class CRM_Deletion extends SeleniumBase {
	...
	public void Delete_PreviewCampaign(String CampaignData[]) {
	...
	@Test(dataProvider = "CampaignData")
	public void Delete_InboundCampaign(String CampaignData[]) throws InterruptedException {
	...
	@Test(dataProvider = "CampaignData")
	public void Delete_PredictiveCampaign(String CampaignData[]) {
	...
	deleteAssert(CampaignData[12]);
	

	}

	@Test(dataProvider = "CampaignData")
	public void Delete_PowerCampaign(String CampaignData[]) {
	...
	deleteAssert(CampaignData[15]);
	}


	@Test(dataProvider = "CampaignData")
	public void Delete_VoiceCampaign(String CampaignData[]) {
